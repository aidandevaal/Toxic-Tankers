...
class spawnable(object):
        win.blit(pygame.image.load('gun.png'), (300, 373))
...
while run:
        ...
        while pw == True:
                for bullet2 in bullets2:                  #zombie 1 hit
                        if bullet.y - bullet2.radius < zombie.hitbox[1] + zombie.hitbox[3] and bullet2.y + bullet2.radius > zombie.hitbox[1]:
                                if bullet2.x + bullet2.radius > zombie.hitbox[0] and bullet2.x - bullet2.radius < zombie.hitbox[0] + zombie.hitbox[2]:
                                        zombie.hit()
                                        score += 5
                                        bullets2.pop(bullets2.index(bullet2))

                for bullet2 in bullets2:                  #zombie 2 hit
                        if bullet2.y - bullet2.radius < zombie2.hitbox2[1] + zombie2.hitbox2[3] and bullet2.y + bullet2.radius > zombie2.hitbox2[1]:
                                if bullet2.x + bullet2.radius > zombie2.hitbox2[0] and bullet2.x - bullet2.radius < zombie2.hitbox2[0] + zombie2.hitbox2[2]:
                                        zombie2.hit2()
                                        score += 5
                                        bullets2.pop(bullets2.index(bullet2))

                for bullet2 in bullets2:                  #zombie 3 hit
                        if bullet2.y - bullet2.radius < zombie3.hitbox3[1] + zombie3.hitbox3[3] and bullet2.y + bullet2.radius > zombie3.hitbox3[1]:
                                if bullet2.x + bullet2.radius > zombie3.hitbox3[0] and bullet2.x - bullet2.radius < zombie3.hitbox3[0] + zombie3.hitbox3[2]:
                                        zombie3.hit3()
                                        score += 5
                                        bullets2.pop(bullets2.index(bullet2))


                if bullet2.x < 700 and bullet2.x > 0:             #Code to make the bullets disappear after they leave the game boundaries so that the game doesn't lag
        ...
        if pressed[pygame.K_SPACE] and shootLoop == 0:          #How to shoot
                ...
                while pw == True:
                        if len(bullets2) < 20:
                                bullets2.append(projectiles(round(man.x + man.width //2), round(man.y + man.height //2), 6, (0,0,0), facing))
        ...
        while pw == True:
                if player == 300 and player == 373:
                                        spawnable.x == 7000
                                        walkRight = (pygame.image.load("p1.png"))
                                        walkLeft = (pygame.image.load("p2.png"))
                                        class projectiles2(object): #SHOTS, SHOTS, SHOTS, SHOTS, SHOTS, SHOTS, EVERYBODY (bullets)                                      
                                                def __init__(self,x,y,radius,color,facing):
                                                        self.x = x
                                                        self.y = y
                                                        self.radius = radius
